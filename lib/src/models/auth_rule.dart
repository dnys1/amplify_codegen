...
extension DefaultProvider on AuthStrategy {
  AuthProvider get defaultProvider {
    switch (this) {
      case AuthStrategy.owner:
      case AuthStrategy.groups:
      case AuthStrategy.private:
        return AuthProvider.userPools;
      case AuthStrategy.public:
        return AuthProvider.apiKey;
      case AuthStrategy.custom:
        return AuthProvider.lambda;
    }
...
class AuthProvider extends EnumClass {
  ...
  static const AuthProvider lambda = _$lambda;
...
abstract class AuthRule implements Built<AuthRule, AuthRuleBuilder> {
  ...
  static void _setDefaults(AuthRuleBuilder b) {
    ...
    b.provider ??= b.allow?.defaultProvider;
  }
