...
class DoubleTypeModel extends Model {
  ...
  const DoubleTypeModel._internal(
      {required this.id,
      double? value,
      TemporalDateTime? createdAt,
      TemporalDateTime? updatedAt})
  ...
  static const id$ = QueryField<dynamic>(fieldName: 'doubleTypeModel.id');
  ...
  DoubleTypeModel copyWith(
      {String? id,
      double? value,
      TemporalDateTime? createdAt,
      TemporalDateTime? updatedAt}) {
    return DoubleTypeModel(
        id: id ?? this.id,
